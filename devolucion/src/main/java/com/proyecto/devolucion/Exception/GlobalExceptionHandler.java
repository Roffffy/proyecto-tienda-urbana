...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DevolucionNotFoundExcepcion.class)
    public ResponseEntity<ErrorResponseDTO> manejarDevolucionNoEncontrado(
            DevolucionNotFoundExcepcion ex,
            HttpServletRequest request) {

        logger.warn("Recurso no encontrado - ID: {} | Path: {} | Mensaje: {}",
                ex.getDevolucionId(), request.getRequestURI(), ex.getMessage());
    ...
    public ResponseEntity<ErrorResponseDTO> manejarValidacion(
        ...
        // Extraer el mensaje de error de cada campo que fallo la validacion
